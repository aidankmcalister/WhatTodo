const Feature = ({ title, description }) => {
  return (
    <div className="h-32 rounded-md bg-neutral-100 p-5 dark:bg-gray-800">
      <h1 className="mb-3 text-xl font-bold text-gray-800 dark:text-gray-300">
        {title}
      </h1>
...
const FeaturesSection = () => {
  return (
    <section className="2-full flex flex-col items-center justify-center space-y-3">
      ...
      <div className="space-y-3  lg:columns-2 lg:space-y-0 ">
        <Feature
